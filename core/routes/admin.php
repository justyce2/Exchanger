...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ExchangeController')->prefix('exchange')->name('exchange.')->group(function () {
        Route::get('/{scope}', 'ExchangeController@index')->name('list');
        Route::get('details/{id}', 'ExchangeController@details')->name('details');
        Route::post('exchange/cancel/{id}', 'ExchangeController@cancel')->name('cancel');
        Route::post('exchange/approve/{id}', 'ExchangeController@approve')->name('approve');
        Route::post('exchange/refund/{id}', 'ExchangeController@refund')->name('refund');
        Route::get('exchange/download/{id}', 'ExchangeController@download')->name('download');
    });
