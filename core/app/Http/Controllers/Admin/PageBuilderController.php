...
class PageBuilderController extends Controller
{
    ...
    public function managePagesSave(Request $request){
        ...
        $exist = Page::where('template_name', $this->activeTemplate)->where('slug', slug($request->slug))->count();
        if($exist){
    ...
    public function managePagesUpdate(Request $request){
        ...
        $exist = Page::where('template_name', $this->activeTemplate)->where('slug',$slug)->first();
