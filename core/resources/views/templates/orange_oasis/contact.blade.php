...
@section('content')
    @if ($contact)
                                ...
                                <div class="contact-info">
                                    <div class="info-item d-flex gap-3 fs--18px">
                                        ...
                                        <div class="info-item__content">
                                            <h6 class="info-item__title mb-2 fw-600">{{ __($element->data_values->heading) }}</h6>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-form form-wrapper">
                            ...
                            <form action="{{ route('contact') }}" method="POST" class="verify-gcaptcha">
                                ...
                                <x-captcha />
                                <button type="submit" class="btn btn--base w-100 fs--18px mt-3">@lang('Submit')</button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="map-wrapper">
            <iframe class="map" src="{{ @$contact->data_values->map_url }}" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
            </iframe>
        </div>
    @endsection
@endif
