...
<head>
    ...
    <title>{{ $general->site_name }} - {{ __($pageTitle) }}</title>
...
<style>
    ...
    .primary-text {
        color: #<?php echo $general->base_color; ?>;
    }
    ...
    .table>thead {
        ...
        background: #<?php echo $general->base_color; ?>;
        color: white;
    }
                            ...
                            <ul class="list exchange-list">
                                <li>
                                    <div class="exchange-card">
                                        ...
                                        <span class="exchange-card__content text-end">{{ __(@$exchange->sendCurrency->name) }}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="exchange-card">
                                ...
                                <li>
                                    <div class="exchange-card">
                                        ...
                                        <span class="exchange-card__content text-end">
                                            <span class="text-danger">{{ showAmount(@$exchange->sending_charge) }} {{ __(@$exchange->sendCurrency->cur_sym) }}</span>
                                        </span>
                                    </div>
                                </li>
                                <li>
                                    <div class="exchange-card">
                                        ...
                                        <span class="exchange-card__content text-end">
                                            <span>{{ showAmount(@$exchange->sending_amount + @$exchange->sending_charge) }}</span>
                                            <span>{{ __(@$exchange->sendCurrency->cur_sym) }}</span>
                                        </span>
                                    </div>
                                </li>
                            ...
                            <ul class="list exchange-list">
                                <li>
                                    <div class="exchange-card">
                                        ...
                                        <span class="exchange-card__content text-end">{{ __(@$exchange->receivedCurrency->name) }}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="exchange-card">
                                ...
                                <li>
                                    <div class="exchange-card">
                                        ...
                                        <span class="exchange-card__content text-end">
                                            ...
                                            <span>{{ __(@$exchange->receivedCurrency->cur_sym) }}</span>
                                        </span>
                                    </div>
                                </li>
                                <li>
                                    <div class="exchange-card">
                                        ...
                                        <span class="exchange-card__content text-end">
                                            <span class="text-danger">{{ showAmount(@$exchange->receiving_charge) }} {{ __(@$exchange->receivedCurrency->cur_sym) }}</span>
                                        </span>
                                    </div>
                                </li>
                                <li>
                                    <div class="exchange-card">
                                        ...
                                        <span class="exchange-card__content text-end">
                                            <span>{{ showAmount($exchange->receiving_amount - @$exchange->receiving_charge) }}</span>
                                            <span>{{ __(@$exchange->receivedCurrency->cur_sym) }}</span>
                                        </span>
                                    </div>
                                </li>
                        ...
                        <ul class="list exchange-list">
                            ...
                            <li>
                                <div class="exchange-card">
                                    ...
                                    <span class="exchange-card__content text-end">{{ showDateTime($exchange->created_at) }}</span>
                                </div>
                            </li>
                            @if ($exchange->admin_feedback != null)
                                <li>
                                    <div class="exchange-card">
                                        ...
                                        @endif
                                        <span class="exchange-card__content text-end">{{ __($exchange->admin_feedback) }}</span>
                                    </div>
                                </li>
                            @endif
                        </ul>
            ...
            <div class="row">
                <div class="col-12">
                    <span class="d-block text-center">
                        @lang('Powered By')
                        <a href="{{ route('home') }}" class="footer-link">{{ __($general->site_name) }}</a>
                    </span>
                </div>
            </div>
        </div>
