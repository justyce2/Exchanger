    ...
    <div class="col-sm-8 col-lg-8 col-xl-6 mx-auto">
        <div class="card border--primary parent">
            <div class="card-header bg--primary">
                ...
                @if($general->exchange_commission == 0)
                <a href="{{ route('admin.referral.status') }}" class="btn btn--success btn-sm float-end"><i class="las la-toggle-on"></i> @lang('Enable Now')</a>
                @else
                <a href="{{ route('admin.referral.status') }}" class="btn btn--danger btn-sm float-end"><i class="las la-toggle-off"></i> @lang('Disable Now')</a>
                @endif
            </div>
            <div class="card-body">
                ...
                <div class="form-group mb-0">
                    ...
                    <div class="input-group">
                        <input type="text" name="level" min="1" placeholder="@lang('Type a number & hit ENTER ↵')" class="form-control">
