            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <div class="widget-two__content">
                            ...
                            <p class="text-white">@lang('Withdrawn')</p>
                        </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $totalExchange }}</h3>
                            <p class="text-white">@lang('Exchanges')</p>
                        </div>
                        <a href="{{ route('admin.exchange.list', 'list') }}?user_id={{ $user->id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $totalTicket }}</h3>
                            <p class="text-white">@lang('Suport Tickets')</p>
                        </div>
                        <a href="{{ route('admin.ticket.index') }}?user_id={{ $user->id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
            </div>
