...
@section('panel')
    ...
    <!-- Modal -->
    <div class="modal fade" id="importConfimationModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
@push('breadcrumb-plugins')
    ...
    @if (!empty($templates))
        <div class="form-inline float-sm-end">
            <form action="{{ route('admin.frontend.import', $key) }}" method="post" id="importForm">
                <div class="input-group">
                    @csrf
                    ...
                    <button type="submit" class="input-group-text btn btn-sm btn--primary" id="importContent">@lang('Import')</button>
                </div>
            </form>
        </div>
    @endif
    ...
    <script>
        (function($) {
            ...
            $('#importContent').on('click', function(e) {
                e.preventDefault();
                let modal = $('#importConfimationModal');
